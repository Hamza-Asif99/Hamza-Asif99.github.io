        ...
        <div id="navSupportedContent" class="collapse navbar-collapse navItems">
            ...
            <ul class="navbar-nav active">
                ...
                <li>
                    ...
                    <a href="/shoppingCart" onclick="changeStorage()" title="Shopping Cart" class="nav-link"><i class="fas fa-shopping-cart"></i></a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container itemsDisplay">
        ...
        <div class="row">
            ...
            <div class="col-12 offset-lg-1 col-lg-7 productDetails ">
                ...
                <!-- <div><input type="text" onblur="validate()" id="quantity" style="display: none;">How many items do you want to add to cart?</div> -->
            
                <!-- <button class="btn" onclick="addCart()" id="addNow" style="display:none">Add Now</button>
                <div class="text-danger"id="error" style="display: none;">Please enter a valid number b/w 1-9</div> -->
            </div>
        </div>
